			...
			<ul
               ...
               with font-awesome or any other icon font library -->
				<li class="nav-item has-treeview menu-open"><a href="#"
					class="nav-link"> <i class="nav-icon fas fa-coffee"></i>
						<p>
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a
							href="getBoardList.do?cafe=STARBUCKS&page=1" class="nav-link ">
								<i class="far fa-circle nav-icon"></i>
								<p>STARBUCKS</p>
						</a></li>
						<li class="nav-item"><a
							href="getBoardList.do?cafe=COFFEEBEAN&page=1" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>COFFEEBEAN</p>
						</a></li>
						<li class="nav-item"><a
							href="getBoardList.do?cafe=TWOSOME&page=1" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>TWOSOME</p>
						</a></li>
					</ul></li>
