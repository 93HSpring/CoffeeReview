...
<body class="hold-transition sidebar-mini layout-navbar-fixed">
	<div class="wrapper">
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item d-none d-sm-inline-block"><a href="index.jsp" class="nav-link">Home</a></li>
			<li class="nav-item d-none d-sm-inline-block"><a href="#" class="nav-link">임시</a></li>
		</ul>
		...
		<a href="index.jsp" class="brand-link"> <img src="resources/image/logo.png" alt="coffeereview.png" class="brand-image img-circle elevation-3" style="opacity: .8"> <span class="brand-text font-weight-light">CoffeeReview</span>
		</a> <!-- Sidebar -->
		<div class="sidebar">
			<c:choose>
				...
				<c:otherwise>
					<!-- Sidebar user panel (optional) (log in complete) -->
					<div class="user-panel mt-3 pb-3 mb-3 d-flex">
						<div class="image">
			...
			<ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
				...
				<a href="#" class="nav-link"> <i class="nav-icon fas fa-coffee"></i>
						<p>
							CAFES <i class="right fas fa-angle-left"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="getBoardList.do?cafe=STARBUCKS&page=1" class="nav-link "> <i class="far fa-circle nav-icon"></i>
								<p>STARBUCKS</p>
						</a></li>
						<li class="nav-item"><a href="getBoardList.do?cafe=COFFEEBEAN&page=1" class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>COFFEEBEAN</p>
						</a></li>
						<li class="nav-item"><a href="getBoardList.do?cafe=TWOSOME&page=1" class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>TWOSOME</p>
						</a></li>
					</ul></li>
		...
		<!-- Default to the left --> <strong>Copyright &copy; 2020 <a href="https://github.com/93HSpring/CoffeeReview">93HSpring/CoffeeReview</a>.
